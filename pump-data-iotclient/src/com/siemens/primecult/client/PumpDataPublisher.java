...
public class PumpDataPublisher {
	 ...
	 * UaClient("opc.tcp://14.97.191.56:4841/OpcUaServer_901"); final
	 ...
	 * uaClient.setSecurityMode(new SecurityMode(SecurityPolicy.NONE,
	 * MessageSecurityMode.None)); uaClient.setUserIdentity(new UserIdentity("alam",
	 * "daac")); uaClient.connect(); } catch (Exception exception) {
